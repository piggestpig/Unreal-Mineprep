...
| 推荐配置 | 参考配置（我们制作动画所用的电脑） |
| :--- | :--- |
| - 支持硬件光线追踪的显卡<br>(NVIDIA 20系，AMD 6000系，Intel Arc 或 Apple M3 及以上)<br>- 32G以上内存和12G以上显存<br>- SSD固态硬盘 | - CPU：i7-13700K<br>- 内存：32G*2 DDR5-6400MHz<br>- 显卡：RTX 4080 (16G)<br>- 硬盘：2TB + 4TB PCIe 4.0 SSD |
