...
(zip) 下载较为稳定的大版本；或者点击上面的绿色`Code`按钮 -> `Download ZIP`，下载最新快照版本。
...
### 最低配置
- 支持硬件光线追踪的显卡（NVIDIA 20系，AMD 6000系，Intel Arc 或 Apple M3 及以上）
- 32G以上内存和10G以上显存
- SSD固态硬盘
...
> · E5实在是太太太慢了，别看有18个核心，编译着色器竟然花了半小时，进编辑器只有四五十帧qwq  
> 我第一次直观感受到单核性能的重要性
> · 真的有人用linux做动画吗？
...
· 大显存！大显存！大显存！显存是流畅运行的基础。DX12（Windows默认的图形API）在爆显存后能使用共享内存继续渲染，此时速度会慢10倍左右。Vulkan爆显存则会直接崩溃。
...
- 新增12bit 4:2:0、12bit 4:2:2、12bit 4:4:4三种色度抽样选项。CPU H.265编码支持所有9种选项，其他GPU编码如下所示：

|   | 10bit 4:2:0 | 10bit 4:2:2 | 10bit 4:4:4 | 12bit 4:2:0 |
| :---: | :---: | :---: | :---: | :---: |
| Nvidia | ✅ <br> p010le | ℹ️仅50系 <br> p210le | ✅ <br> yuv444p10msble | - |
| Intel | ✅ <br> p010le | ✅ <br> y210le | - | ✅ <br> p012le |
| AMD | ✅ <br> p010le | - | - | - |
| Apple | ✅ <br> p010le | ✅ <br> p210le | - | - |
| Vulkan | ✅ <br> p010le | - | - | - |
